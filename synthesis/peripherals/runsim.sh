...
MODULES="pgm_tb tb_render TestRunner"
...
FILES='video_types.sv control.inf whizgraphics_render_tb.sv whizgraphics.sv data_bus.inf data_bus_tb.sv memory.sv test.pkg test_runner.sv'
FILES=`echo "$FILES" | tr " " "\n"`
for i in $FILES 
do
    echo Compiling $i
