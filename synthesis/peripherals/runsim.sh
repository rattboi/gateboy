...
MODULES="pgm_tb tb_render w_tb w_mem_tb palette_tb"
...
FILES='video_types.sv control.inf whizgraphics_render_tb.sv whizzgraphics_mem_tb.sv whizzgraphics_tb.sv  whizgraphics.sv pgm_tb.sv data_bus.inf data_bus_tb.sv memory.sv palette_tb.sv test.pkg test_runner.sv'
FILES=`echo "$FILES" | tr " " "\n"`
for i in $FILES 
do
    echo Compiling $i
